...
def responder():
    ...
    elif "não funcionou" in msg or "erro" in msg:
    ...
    # Default
    resposta.append({"message": "Me diga qual dispositivo você vai usar (TV, celular, computador...) que eu te explico como começar! 😉"})
    return jsonify({"replies": resposta})
